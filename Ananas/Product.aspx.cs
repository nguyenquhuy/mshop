        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           /* string Gender = Request.QueryString["gender"];*/////////////////////////////
            foreach (Products p in arr)
            {
                ...
                //Gender//////////////////////
                //else if (Request.QueryString["gender"] != null)
                //{
                //    if (p.gender == Gender)
                //    {
                //        if (Gender == "1") { titleproducts.Text = "Sản phẩm nữ"; }///////////////////////////////
                //        shtml += "<div class=\"list__view-item col-4\">" +
                //              "<div class=\"item--bag\">" +
                //                   "<a class=\"linkdetail\" href=\"Prodetail.aspx?id=" + p.id + "\" title =\"Chi tiết sản phẩm\" name=\"linkdetail\">Chi tiết</a>" +
                //                   "<a href = \"Prodetail.aspx?id=" + p.id + "\" name=\"linkdetail\">" + "<img src =\"" + p.img + "\"/></a>" +
                ...
                else
                {
                    ...
                    //--------------------Tìm theo khoảng----------------//
                    //else if (Request.QueryString["price--fromto"] != null)
                    //{
                    //    string price2 = Request.QueryString["price--from"];
                    //    string price3 = Request.QueryString["price--to"];
                    //    if (p.price > double.Parse(price2) && p.price < double.Parse(price3))
                    //    {
                    //        titleproducts.Text = "Tim theo khoang tu "+price2 +" den "+price3;
                    //        shtml += "<div class=\"list__view-item col-4\">" +
                    //                 "<div class=\"item--bag\">" +
                    //                      "<a class=\"linkdetail\" href=\"Prodetail.aspx?id=" + p.id + "\" title =\"Chi tiết sản phẩm\" name=\"linkdetail\">Chi tiết</a>" +
                    //                      "<a href = \"Prodetail.aspx?id=" + p.id + "\" name=\"linkdetail\">" + "<img src =\"" + p.img + "\"/></a>" +
            ...
            if (Request.Form["btnaddtocart"] != null)
            {
                ...
                for (int i = 0; i < arr.Count; i++)
                {
                    if (arr[i].id == idadd)
                    {
                        ...
                        cart.Add(c);
                        loiproduct.Text = "Ban vua them " + arr[i].name;
                        break;
