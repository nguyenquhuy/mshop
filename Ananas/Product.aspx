        ...
        <div class="container__products--sidebar col-3">
            ...
            <div class="sidebar__products--types">
                <div class="types--content">
                    DÒNG SẢN PHẨM                
                        <ul class="types--list">
                            <li><a href="Product.aspx?type=1" class="types--item">Piano</a></li>
                            <li><a href="Product.aspx?type=2" class="types--item">Guitar</a></li>
                            <li><a href="Product.aspx?type=3" class="types--item">Organ</a></li>
                        </ul>
                    </div>
            </div>
